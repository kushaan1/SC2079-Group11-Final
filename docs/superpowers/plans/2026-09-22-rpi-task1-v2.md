...
## Rule deltas vs. the 2026-09-17 original (added 2026-09-22)
...
Both are additions to code this plan already describes building — `vision_worker.decide()` and
`Task1Run.run()` — not new tasks or new files. When implementing the corresponding step below, apply
the change described in its row above. Everything from this point to the end of the document is
shuenwei's original 2026-09-17 plan, unchanged.
